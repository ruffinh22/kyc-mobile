...
const s = StyleSheet.create({
  ...
  list: { paddingHorizontal: 8, paddingTop: 4, paddingBottom: 36 },
  separator: { height: 2 },
  card: {
  ...
  controlBar: { flexDirection: 'column', gap: 6, paddingHorizontal: 8, paddingBottom: 6 },
  filterPills: { flexDirection: 'row', gap: 4, marginBottom: 5, alignItems: 'center', paddingVertical: 0, paddingRight: 6 },
  filterChip: {
    paddingVertical: 4,
    paddingHorizontal: 10,
    borderRadius: 999,
  ...
  filterText: { color: C.ink3, fontSize: 10, fontWeight: '700' },
  filterTextActive: { color: C.blue },
  searchRow: { flexDirection: 'row', alignItems: 'center', gap: 5, marginBottom: 4 },
  sortBar: { flexDirection: 'row', gap: 5, alignItems: 'center' },
  searchInputRow: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 5, minWidth: 100 },
  searchInput: {
    flex: 1,
    minHeight: 28,
    maxWidth: 190,
