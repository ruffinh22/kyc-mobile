...
export interface Dossier {
  ...
  photo_signature?: string | null; signature_mode?: 'dessin' | 'empreinte' | null;
  score_visage: number | null; visage_match: number | null; visage_motif: string | null;
  acquisition_status: string | null; flow_step?: number | null;
  ...
  type_piece?: string | null; date_naissance?: string | null; lieu_naissance?: string | null;
  date_expiration?: string | null; adresse_complete?: string | null;
  numero_cni?: string | null; sexe?: string | null; nationalite?: string | null;
  profession?: string | null; autre_numero?: string | null; ocr_overrides?: string | null;
