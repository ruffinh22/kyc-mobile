export const migration = {
  name: '20260804_add_missing_dossier_columns',
  async up(pool: any) {
    ...
    try {
      ...
      const definitions: Array<{ field: string; sql: string }> = [
        ...
        { field: 'signature_mode', sql: 'ALTER TABLE dossiers ADD COLUMN signature_mode VARCHAR(30) DEFAULT NULL' },
        { field: 'photo_signature', sql: 'ALTER TABLE dossiers ADD COLUMN photo_signature VARCHAR(300) DEFAULT NULL' },
